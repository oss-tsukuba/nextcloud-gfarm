...
NEXTCLOUD_FILES_SCAN_TIME=${NEXTCLOUD_FILES_SCAN_TIME-'10 5 * * *'}
#### empty means disabled
NEXTCLOUD_BACKUP_TIME=${NEXTCLOUD_BACKUP_TIME-'10 2 * * *'}
...
NEXTCLOUD_TRUSTED_DOMAINS=${NEXTCLOUD_TRUSTED_DOMAINS:-${SERVER_NAME}}
